...
maxServoAngle1 = math.pi/2
minServoAngle1 = -math.pi/2
maxServoAngle2 = 2*math.pi
minServoAngle2 = math.pi
maxServoAngle3 = math.pi*0.7
minServoAngle3 = -math.pi*0.7
maxServoAngle4 = math.pi*0.6
minServoAngle4 = -math.pi*0.6
maxGrab = 20
minGrab = 0
...
def onKeyPress(event):
	...
	baseRot = max(min(baseRot,maxServoAngle1),minServoAngle1)
	#limit the grab
...
def main():
	...
	global armLength3
	global floorLevel
	global maxServoAngle1
	global minServoAngle1
	global maxServoAngle2
	global minServoAngle2
	global maxServoAngle3
	global minServoAngle3
	global maxServoAngle4
	global minServoAngle4
	global goToPoint
	...
	arm1rot = max(min(arm1rot,maxServoAngle2),minServoAngle2)
	arm2rot = max(min(arm2rot,maxServoAngle3),minServoAngle3)
	arm3rot = max(min(arm3rot,maxServoAngle4),minServoAngle4)
